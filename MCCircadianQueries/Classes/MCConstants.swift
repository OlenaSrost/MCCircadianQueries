...
public struct HMConstants
{
    ...
    public let hkToMCDB : [String : String] = [
        HKCategoryTypeIdentifier.appleStandHour.rawValue           : "apple_stand_hour",
        HKCategoryTypeIdentifier.sleepAnalysis.rawValue        : "sleep_duration",
        HKQuantityTypeIdentifier.activeEnergyBurned.rawValue        : "active_energy_burned",
        ...
        HKQuantityTypeIdentifier.bloodPressureDiastolic.rawValue    : "diastolic_blood_pressure",
        HKQuantityTypeIdentifier.bloodPressureSystolic.rawValue     : "systolic_blood_pressure",
        HKQuantityTypeIdentifier.bodyFatPercentage.rawValue         : "body_fat_percentage",
        HKQuantityTypeIdentifier.bodyMass.rawValue                  : "body_weight",
        ...
        HKQuantityTypeIdentifier.dietaryVitaminA.rawValue           : "dietary_vitamina",
        HKQuantityTypeIdentifier.dietaryVitaminB12.rawValue         : "dietary_vitaminb12",
        HKQuantityTypeIdentifier.dietaryVitaminB6.rawValue          : "dietary_vitaminb6",
        HKQuantityTypeIdentifier.dietaryVitaminC.rawValue           : "dietary_vitaminc",
        HKQuantityTypeIdentifier.dietaryVitaminD.rawValue           : "dietary_vitamind",
        HKQuantityTypeIdentifier.dietaryVitaminE.rawValue           : "dietary_vitamine",
        HKQuantityTypeIdentifier.dietaryVitaminK.rawValue           : "dietary_vitamink",
        ...
        HKQuantityTypeIdentifier.forcedExpiratoryVolume1.rawValue   : "forced_expiratory_volume_one_second",
        ...
        HKQuantityTypeIdentifier.height.rawValue                    : "body_height",
        ...
        HKQuantityTypeIdentifier.nikeFuel.rawValue                  : "nike_fuel",
        ...
        HKQuantityTypeIdentifier.peakExpiratoryFlowRate.rawValue    : "peak_expiratory_flow",
    ...
    public let mcdbToHK : [String: String] = [
        "apple_stand_hour"                    : HKCategoryTypeIdentifier.appleStandHour.rawValue            ,
        "sleep_duration"                      : HKCategoryTypeIdentifier.sleepAnalysis.rawValue             ,
        "active_energy_burned"                : HKQuantityTypeIdentifier.activeEnergyBurned.rawValue        ,
        "basal_body_temperature"              : HKQuantityTypeIdentifier.basalBodyTemperature.rawValue      ,
        "basal_energy_burned"                 : HKQuantityTypeIdentifier.basalEnergyBurned.rawValue         ,
        "blood_alcohol_content"               : HKQuantityTypeIdentifier.bloodAlcoholContent.rawValue       ,
        "blood_glucose"                       : HKQuantityTypeIdentifier.bloodGlucose.rawValue              ,
        "diastolic_blood_pressure"            : HKQuantityTypeIdentifier.bloodPressureDiastolic.rawValue    ,
        "systolic_blood_pressure"             : HKQuantityTypeIdentifier.bloodPressureSystolic.rawValue     ,
        "body_fat_percentage"                 : HKQuantityTypeIdentifier.bodyFatPercentage.rawValue         ,
        "body_weight"                         : HKQuantityTypeIdentifier.bodyMass.rawValue                  ,
        "body_mass_index"                     : HKQuantityTypeIdentifier.bodyMassIndex.rawValue             ,
        "body_temperature"                    : HKQuantityTypeIdentifier.bodyTemperature.rawValue           ,
        "dietary_biotin"                      : HKQuantityTypeIdentifier.dietaryBiotin.rawValue             ,
        "dietary_calcium"                     : HKQuantityTypeIdentifier.dietaryCalcium.rawValue            ,
        "dietary_caffeine"                    : HKQuantityTypeIdentifier.dietaryCaffeine.rawValue           ,
        "dietary_carbohydrates"               : HKQuantityTypeIdentifier.dietaryCarbohydrates.rawValue      ,
        "dietary_cholesterol"                 : HKQuantityTypeIdentifier.dietaryCholesterol.rawValue        ,
        "dietary_chloride"                    : HKQuantityTypeIdentifier.dietaryChloride.rawValue           ,
        "dietary_chromium"                    : HKQuantityTypeIdentifier.dietaryChromium.rawValue           ,
        "dietary_copper"                      : HKQuantityTypeIdentifier.dietaryCopper.rawValue             ,
        "dietary_energy_consumed"             : HKQuantityTypeIdentifier.dietaryEnergyConsumed.rawValue     ,
        "dietary_fat_monounsaturated"         : HKQuantityTypeIdentifier.dietaryFatMonounsaturated.rawValue ,
        "dietary_fat_polyunsaturated"         : HKQuantityTypeIdentifier.dietaryFatPolyunsaturated.rawValue ,
        "dietary_fat_saturated"               : HKQuantityTypeIdentifier.dietaryFatSaturated.rawValue       ,
        "dietary_fat_total"                   : HKQuantityTypeIdentifier.dietaryFatTotal.rawValue           ,
        "dietary_fiber"                       : HKQuantityTypeIdentifier.dietaryFiber.rawValue              ,
        "dietary_folate"                      : HKQuantityTypeIdentifier.dietaryFolate.rawValue             ,
        "dietary_iodine"                      : HKQuantityTypeIdentifier.dietaryIodine.rawValue             ,
        "dietary_iron"                        : HKQuantityTypeIdentifier.dietaryIron.rawValue               ,
        "dietary_magnesium"                   : HKQuantityTypeIdentifier.dietaryMagnesium.rawValue          ,
        "dietary_manganese"                   : HKQuantityTypeIdentifier.dietaryManganese.rawValue          ,
        "dietary_molybdenum"                  : HKQuantityTypeIdentifier.dietaryMolybdenum.rawValue         ,
        "dietary_niacin"                      : HKQuantityTypeIdentifier.dietaryNiacin.rawValue             ,
        "dietary_pantothenic_acid"            : HKQuantityTypeIdentifier.dietaryPantothenicAcid.rawValue    ,
        "dietary_phosphorus"                  : HKQuantityTypeIdentifier.dietaryPhosphorus.rawValue         ,
        "dietary_potassium"                   : HKQuantityTypeIdentifier.dietaryPotassium.rawValue          ,
        "dietary_protein"                     : HKQuantityTypeIdentifier.dietaryProtein.rawValue            ,
        "dietary_riboflavin"                  : HKQuantityTypeIdentifier.dietaryRiboflavin.rawValue         ,
        "dietary_selenium"                    : HKQuantityTypeIdentifier.dietarySelenium.rawValue           ,
        "dietary_sodium"                      : HKQuantityTypeIdentifier.dietarySodium.rawValue             ,
        "dietary_sugar"                       : HKQuantityTypeIdentifier.dietarySugar.rawValue              ,
        "dietary_thiamin"                     : HKQuantityTypeIdentifier.dietaryThiamin.rawValue            ,
        "dietary_vitamina"                    : HKQuantityTypeIdentifier.dietaryVitaminA.rawValue           ,
        "dietary_vitaminb12"                  : HKQuantityTypeIdentifier.dietaryVitaminB12.rawValue         ,
        "dietary_vitaminb6"                   : HKQuantityTypeIdentifier.dietaryVitaminB6.rawValue          ,
        "dietary_vitaminc"                    : HKQuantityTypeIdentifier.dietaryVitaminC.rawValue           ,
        "dietary_vitamind"                    : HKQuantityTypeIdentifier.dietaryVitaminD.rawValue           ,
        "dietary_vitamine"                    : HKQuantityTypeIdentifier.dietaryVitaminE.rawValue           ,
        "dietary_vitamink"                    : HKQuantityTypeIdentifier.dietaryVitaminK.rawValue           ,
        "dietary_water"                       : HKQuantityTypeIdentifier.dietaryWater.rawValue              ,
        "dietary_zinc"                        : HKQuantityTypeIdentifier.dietaryZinc.rawValue               ,
        "electrodermal_activity"              : HKQuantityTypeIdentifier.electrodermalActivity.rawValue     ,
        "forced_expiratory_volume_one_second" : HKQuantityTypeIdentifier.forcedExpiratoryVolume1.rawValue   ,
        "forced_vital_capacity"               : HKQuantityTypeIdentifier.forcedVitalCapacity.rawValue       ,
        "heart_rate"                          : HKQuantityTypeIdentifier.heartRate.rawValue                 ,
        "body_height"                         : HKQuantityTypeIdentifier.height.rawValue                    ,
        "inhaler_usage"                       : HKQuantityTypeIdentifier.inhalerUsage.rawValue              ,
        "lean_body_mass"                      : HKQuantityTypeIdentifier.leanBodyMass.rawValue              ,
        "nike_fuel"                           : HKQuantityTypeIdentifier.nikeFuel.rawValue                  ,
        "number_of_times_fallen"              : HKQuantityTypeIdentifier.numberOfTimesFallen.rawValue       ,
        "blood_oxygen_saturation"             : HKQuantityTypeIdentifier.oxygenSaturation.rawValue          ,
        "peak_expiratory_flow"                : HKQuantityTypeIdentifier.peakExpiratoryFlowRate.rawValue    ,
        "peripheral_perfusion_index"          : HKQuantityTypeIdentifier.peripheralPerfusionIndex.rawValue  ,
        "respiratory_rate"                    : HKQuantityTypeIdentifier.respiratoryRate.rawValue           ,
        "uv_exposure"                         : HKQuantityTypeIdentifier.uvExposure.rawValue
    ]
